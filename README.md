...
Arc Beta is a customized Redpill Loader for DSM 7.x (Xpenology) including upcoming features with enhanced hardwaresupport, addons, guided (semi-automated) installation and more. Multiple customization options are built-in. It is modified to run on different hardware (More informations in wiki).
